...
function createWindow() {
  ...
  // setHiddenInMissionControl is macOS-only
...
app.whenReady().then(() => {
  ...
  if (process.platform === 'win32') {
    // On Windows, we can't hide the window from taskbar without more complex tray integration
    // So we keep it visible but make it small
  }
